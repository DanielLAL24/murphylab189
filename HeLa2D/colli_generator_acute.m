function [G,tcheck] = colli_generator_acute(n,mu_len,sigma_len,colli_min_number,Dboth,imgcent_coordinate,XYZres,centroradius,stepsize,rand_seed,cellnum,subfolder,batchno,thr)
...
save(['outputs_' num2str(subfolder) '/images/thr_' num2str(thr) '/cell_' num2str(cellnum) '/batch_' num2str(batchno) '/new_n_' num2str(n) '/new_sim_n_' num2str(n) '_mulen_' num2str(mu_len) '_siglen_' num2str(sigma_len) '_colli_' num2str(colli_min_number) '-tcheck.mat'], 'tcheck', 'imgcent_coordinate', 'imXYZ', 'mtXYZ', 'G', 'n','randlengths');
...
save(['outputs_' num2str(subfolder) '/images/thr_' num2str(thr) '/cell_' num2str(cellnum) '/batch_' num2str(batchno) '/new_n_' num2str(n) '/new_sim_n_' num2str(n) '_mulen_' num2str(mu_len) '_siglen_' num2str(sigma_len) '_colli_' num2str(colli_min_number) '.mat'], 'imgcent_coordinate', 'imXYZ', 'mtXYZ', 'G', 'n','randlengths');

delete(['outputs_' num2str(subfolder) '/images/thr_' num2str(thr) '/cell_' num2str(cellnum) '/batch_' num2str(batchno) '/new_n_' num2str(n) '/new_sim_n_' num2str(n) '_mulen_' num2str(mu_len) '_siglen_' num2str(sigma_len) '_colli_' num2str(colli_min_number) '-tcheck.mat']);  %%
