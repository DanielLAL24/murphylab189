...
% simulated image parameters + features
...
[image,A,B,imgcent_coordinate] = getrealimage_hela(cellnum);
feat_vector_ori = real_im_feat_extract(image,imgcent_coordinate,w,cellnum);

load allrealfeats all_feat_vector2 idxes

feat_vector = all_feat_vector2;
...
feat_vector = all_feat_vector2(:,ffidx); % real images, for normalization
%feat_vector_ori = feat_vector_ori(ffidx); % query image
feat_vector_MI = feat_vector_MI(:,ffidx); % simulated images library
