...
load(['./real_allfeatures_w',num2str(7),'_s',num2str(subfolder),'.mat'],'batchno_all','fin_mat_all');
allss = fin_mat_all(:,1);
clear fin_mat_all  

rand_start = [3,7,11,13,17,19,23,29,31,37];

rand_errs = zeros(3, 3, size(w,1), length(rand_start));
