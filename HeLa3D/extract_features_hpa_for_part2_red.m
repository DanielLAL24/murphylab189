...
if ~exist(tmpfile,'file')
    ...
    if ~exist('savefile','file')    
        ...
        output_filename = ['outputs_' num2str(subfolder) '/featvals/cell_' num2str(cellnum) '/batch_' num2str(batchno) '/' imCategory '/' featType '/forpart2_all_feats_G_psf_batch_' num2str(batchno) '.mat'];
        save( output_filename, 'fin_mat' );
