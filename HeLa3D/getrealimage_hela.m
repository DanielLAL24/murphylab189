...
%load(['/home/jieyuel/lib_backup/Microtubules/proc/cell_' num2str(imnum) '/final_info.mat'],'Dbothfin','imgcent_coordinate')
%load(['/home/jieyuel/lib_backup/Microtubules/proc/cell_' num2str(imnum) '/man_seg.mat'],'segdna','segcell');
