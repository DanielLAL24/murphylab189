%function all_script(setno,fieldno)
function [flag] = all_script(setno,fieldno,cellnum,batchno)
...
%subfolder = 2;  %%Jieyue, Erlang
subfolder = 3;  %%Jieyue, Erlang
...
for thr = 6:8
       ...
       for i = 1:length(imagefolders)
	    ...
	    mainScript10_hpa(rand_start,batchno,setno,fieldno,imnum,subfolder,n_inputArray,mulen_inputArray,colli_inputArray,coeff_var_Array,thr);
	    flag = 1;  %%
       end
end
%extract_features_hpa_for_part2(imnum,setno,fieldno,batchno,n_inputArray,mulen_inputArray,colli_inputArray,coeff_var_Array);
