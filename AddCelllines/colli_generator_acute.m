function [G,tcheck] = colli_generator_acute(n,mu_len,sigma_len,colli_min_number,Dboth,imgcent_coordinate,XYZres,centroradius,stepsize,rand_seed,cellnum,setno,fieldno,subfolder,batchno,thr)
