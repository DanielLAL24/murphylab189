...
% ML_CHECKCONSTANT
%   Check constant for vectors
%
% STATUS=ML_CHECKCONSTANT(X)
%   STATUS is 0 if all numbers in X are the same, otherwise 1
% STATUS=ML_CHECKCONSTANT(X1,X2)
%   STATUS is
%       0 - all the same
