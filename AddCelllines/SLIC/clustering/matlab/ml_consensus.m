function [g c]= ml_consensus(feat, name, groupfile, distance, method, penc, niter)
...
%      ml_bootstrap_half([groupfile '.den'], '', features, gene, niter, ma);
      ml_bootstrap_half([groupfile '.den_MRC'], '', features, gene, niter, ma); %For the usage of jl_drawtree.
      %end
%return; %%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

if 1==2  %maybe use jl_drawtree instead!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
%Manually change the 'consensus_tree' in .den_MRC file.
%pause;
